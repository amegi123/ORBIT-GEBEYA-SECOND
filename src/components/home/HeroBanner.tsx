...
export const HeroBanner: React.FC = () => {
  ...
  return (
    <section
      ...
      className="relative w-full h-[620px] sm:h-[720px] lg:h-[780px] bg-slate-950 text-white overflow-hidden select-none lg:cursor-none"
    >
      {/* Synchronized Hero Slides Container */}
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-[#02367B]/30 mix-blend-multiply pointer-events-none" />

                {/* Text Contrast Gradient */}
                <div className="absolute inset-0 bg-gradient-to-r from-slate-950/90 via-[#02367B]/40 to-[#02367B]/20" />
              </div>

              {/* Synchronized Text & Button Content Container */}
              <div className="relative z-10 max-w-[1650px] mx-auto h-full px-6 md:px-16 flex items-center justify-center sm:justify-start">
                <div className="max-w-2xl space-y-5 sm:space-y-6 -mt-10 sm:-mt-16 text-center sm:text-left flex flex-col items-center sm:items-start">
                  {/* Tagline */}
                  ...
                  {/* Main Title */}
                  <h1 className="text-5xl sm:text-7xl lg:text-8xl font-serif tracking-tight leading-[0.95] text-[#46D3E4] font-normal drop-shadow-xl text-center sm:text-left">
                    <span className="block">{slide.line1}</span>
                    <span className="block">{slide.line2}</span>
                  </h1>

                  {/* Delivery Box */}
                  <div className="inline-block border border-amber-400/60 bg-black/60 backdrop-blur-sm px-6 py-2.5 rounded-sm text-xs sm:text-sm text-slate-200 shadow-md">
                    {slide.subtitle}
                  </div>
